...
const PersonelItem = ({ doctor, generatePDF }) => {
      ...
      if (member.id === other.id) {
        if (editedMember.name !== '' && editedMember.contact !== '' && editedMember.experience !== '') {
          ...
          try {
            ...
            const response = await axios.put(`http://localhost:3001/members/${member.id}`, {
              name: member.name,
      ...
      <div className="doctor-container">
        ...
        <div className="doctorItem-title">
          <div className="title-container">
            ...
            <button className="popup-btn" onClick={generatePDF}>Отчет</button>
          </div>
        </div>
                  ...
                  <MyPopup
                    ...
                    popupContent={<div style={{
                      ...
                      {isShow ? <div style={{ fontSize: '1.2rem' }}>
                        ...
                        {userData.role !== 'admin' || userData.username !== '' && (
